...
pygame.display.set_caption("Space Invader remake")
...
def main():
    ...
    def redraw_window():
        ...
        energy_label = main_font.render(f"Energy: {boosts}", 1, (255, 255, 255))

        WIN.blit(lives_label, (10, 10))
        WIN.blit(level_label, (WIDTH - level_label.get_width() - 10, 10))
        WIN.blit(energy_label, (10, 60))
    ...
    while run:
        ...
        if keys[pygame.K_s] and player.y + player_vel + player.get_height() + 15 < HEIGHT: # down
            player.y += player_vel
        if (keys[pygame.K_j] and player.x - player_vel*5 > 0) and boosts > 0:
...
def main_menu():
    ...
    while run:
        ...
        text_label = text_font.render("WASD to move, J and L to use energy to dash left and right", 1, (255, 255, 255))
        WIN.blit(text_label, (WIDTH / 2 - text_label.get_width() / 2, 450))
